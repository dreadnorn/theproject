...
{
    QDir tDir;
    m_directory = tDir.absolutePath() + "/" + QApplication::applicationName();
}
...
//    QString directory = QDir::homePath() + QLatin1String("/deneme");
    QSettings cookieSettings(m_directory + QLatin1String("/cookies.ini"), QSettings::IniFormat);
